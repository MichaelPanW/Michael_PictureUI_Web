...
<html>
	...
	<head>
		...
		<meta charset="utf-8">
		<!-- headerB start -->
		<link rel="shortcut icon" type="image/x-icon" href="/Public/File/images/folder.icon"/>
		<title>檔案管理系統</title>
		<link rel="stylesheet" href="/Public/File/css/reset.css">
		<link rel="stylesheet" href="/Public/File/css/color.css">
		<!--RWD設定--><!--電腦螢幕寬度1920px-1280px-->
		<link href="/Public/File/css/style.css" rel="stylesheet" type="text/css" />
		<!--1280以下--><!--ipad 橫放/電腦螢幕-->
		<link href="/Public/File/css/style-large.css" rel="stylesheet" type="text/css" media="screen and (min-width: 801px) and (max-width: 1279px)"  />
		<!--手機直立/手機橫放/ipad直立-->
		<link href="/Public/File/css/style-small.css" rel="stylesheet" type="text/css" media="screen and (min-width: 0px) and (max-width: 800px)" />
	  	<!--彈跳窗css-->
		<link rel="stylesheet" href="/Public/File/css/reveal.css">	
		<!--燈箱css-->
		<link href="/Public/File/css/jquery.fancybox.css?v=2.1.4" rel="stylesheet" type="text/css" media="screen" />
		<!--右鍵目錄css-->
		<link rel="stylesheet" href="/Public/File/css/jquery.contextmenu.css">
		...
		<header class="window_color">
			<div class="first_bar">
				...
				<form method="get" action="<?php echo U('Index/index');?>">
					<input type="text" name="search" placeholder="搜尋" style="background-image:url('/Public/File/images/musica-searcher.png');" />
				</form>
				</div>
			</div>
			<div class="last_bar">
				<ul class="option">
					<li>
						<a id="upload"><div class="title" style="background-image:url('/Public/File/images/upload-to-cloud.png');" >上傳</div></a>
					</li>
					<li>
						<a  id="download"><div class="title" style="background-image:url('/Public/File/images/cloud-computing.png');" >下載</div></a>
					</li>
					<li>
						<a id="newfold"><div class="title" style="background-image:url('/Public/File/images/new-file.png');" >新資料夾</div></a>
					</li>

					<li>
						<a id="delete"><div class="title" style="background-image:url('/Public/File/images/rubbish-bin.png');" >刪除</div></a>
					</li>
					<li>
						<a id="copy"><div class="title" style="background-image:url('/Public/File/images/copy.png');" >複製</div></a>
					</li>
					<li>
					<a id="move"><div class="title" style="background-image:url('/Public/File/images/move.png');" >移動</div></a>
					</li>
					<li>
					<a id="rename"><div class="title" style="background-image:url('/Public/File/images/rename.png');" >重新命名</div></a>
					</li>
					<li>
					<a id="window" num="9"><div class="title" style="background-image:url('/Public/File/images/icon_picture.png');" >大圖示</div></a>
					</li>
			...
			<div class="path_bar">
				<a href="/index.php/Index/index/parent/<?php echo ($back); ?>"><img src='/Public/File/images/left-arrow.png' class="backbutton" /></a>
				<p>目錄</p>
...
<div  id="dropDIV" class="main" ondragover="dragoverHandler(event)" >
	...
	<?php if(is_array($db_file)): $i = 0; $__LIST__ = $db_file;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i; if($vo[type] == 0): ?><div class="folder obj" style="background-image:url('/Public/File/images/folder.png');" id='<?php echo ($vo["id"]); ?>'>
